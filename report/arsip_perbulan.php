...
<html>
    <head>
        <title>Cetak Data Kehadiran Pegawai Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA KEHADIRAN BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                  ...
                  <th width="30%">Keterangan</th>
                            ...
                            $sql = "SELECT * FROM tb_kehadiranpegawai WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
